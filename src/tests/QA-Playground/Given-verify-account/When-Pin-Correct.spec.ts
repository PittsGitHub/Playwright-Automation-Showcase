...
test("Then 'Success' should be displayed", async ({ verifyAccountFixture, page }) => {
  //Pin provided is 9-9-9-9-9-9
  const pinDigit: string = '9'
  ...
  await expect(verifyAccountFixture.verifyAccountLocators.SuccessDisplay).toBeVisible()
})
