...
test("Then Real Name Should be Anthony 'Tony' Stark", async ({ dynamicTableFixture: dynamicTable }) => {
    const IronManCurrentRow = dynamicTable.dynamicTablePageLocators.IronManRowLocator
...
test('Then Email Should be iron-man@avengers.com', async ({ dynamicTableFixture: dynamicTable }) => {
    const IronManCurrentRow = dynamicTable.dynamicTablePageLocators.IronManRowLocator
